...
This project is indexed by GitNexus as **Mobile-AI-IoT** (2354 symbols, 6445 relationships, 195 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
