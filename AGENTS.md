...
This project is indexed by GitNexus as **Mobile-AI-IoT** (3060 symbols, 8212 relationships, 208 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
