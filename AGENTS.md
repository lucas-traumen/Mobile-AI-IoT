...
This project is indexed by GitNexus as **Mobile-AI-IoT** (2325 symbols, 6370 relationships, 192 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
