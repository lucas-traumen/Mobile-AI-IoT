...
This project is indexed by GitNexus as **Mobile-AI-IoT** (2589 symbols, 7062 relationships, 187 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
